...
public function GetTables()
{
		...
		if ($this->tableindex == null) $this->tableindex = 0;
		...
		if ($this->tablecount == 0) $this->table = new table($this->index, 0, null, $this->connection);
...
public function FetchTable($name)
{
		...
		{
				if ($this->tablelist[$x]->name == $name)	{	return $this->tablelist[$x];		}
		}
}
