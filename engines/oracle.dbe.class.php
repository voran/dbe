...
class OracleExplorer extends connection {
    ...
    {
        $this -> link = @oci_connect($server, $user, $password);
    }

    public function FetchRow()
    {
        return oci_fetch_row($this -> result_id);
    }
    ...
    {
        return oci_result($this -> result_id, $i);
    }
    ...
    public function Execute($query)
    {
        if ($query != $empty) {
            ...
            $exec = @oci_execute($stmnt, OCI_COMMIT_ON_SUCCESS);
            // Perform Query
