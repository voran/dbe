...
/*//////////////////////////////////////////////       ALIASES		/////////////////////////////////////////////////////////*/
public function Connect($server, $user, $password) 	{	$this->link = @ibase_connect($server, $user, $password);		}
public function FetchRow() 		     		{	return $this->FixArray(ibase_fetch_row($this->result_id));	}
public function NumFields()				{	return ibase_num_fields($this->result_id);			}
...
public function ServerError($empty)			{	return ibase_errmsg();						}
public function ConnectionError()			{	return ibase_errmsg();						}
public function EscapeString($string)			{	return $string;							}
...
public function Execute($query)                                                           
	...
	if ($query != $empty)
		...
		{
			$this->result_id = ibase_query($query); // Perform Query
	...
	{
		return "SELECT FIRST 2 * FROM ".$tablename."";//SKIP for offset
	}
