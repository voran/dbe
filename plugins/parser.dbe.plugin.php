 ...
 public function __construct($table)
{
	...
	if ($this->query == 'delete') $this->query = $this->table->GenerateDelete();
	if ($this->query == 'insert') $this->query = $this->table->GenerateInsert();
	if ($this->query == 'update') $this->query = $this->table->GenerateUpdate();
...
public function Show()
{
	...
	if ($this->query != null)
	{
		...
		if (htmlspecialchars($_REQUEST['redirect'], ENT_QUOTES) == 'index') $this->Redirect();
